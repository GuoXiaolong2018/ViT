...
class ViT(nn.Module):
    def __init__(self,emb_size=16):
        ...
        self.pos_emb=nn.Parameter(torch.rand(1,self.patch_count**2+1,emb_size))   # position位置向量 (1,seq_len+1,emb_size) #+1：分类token的位置
